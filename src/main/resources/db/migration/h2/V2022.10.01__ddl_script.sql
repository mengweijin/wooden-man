...
create TABLE QBT_GEN_TEMPLATE (
  ...
  category varchar(50) NOT NULL COMMENT '模板类别（mybatis/maybatis-plus/jpa/自定义的模板 等）',
  name varchar(100) NOT NULL COMMENT '生成文件的名称（controller/service/mapper/mapper.xml/entity/vue/layui 等）',
...
insert into QBT_GEN_DATASOURCE values (1576744861023870978, 'H2', 'jdbc:h2:file:./h2/quickboot;DB_CLOSE_ON_EXIT=FALSE;MODE=MYSQL', 'sa', null, null, 0, 'admin', CURRENT_TIMESTAMP(), 'admin', CURRENT_TIMESTAMP());
